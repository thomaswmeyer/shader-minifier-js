...
#define CUBEUV_TEXEL_HEIGHT 0.0625
#define CUBEUV_MAX_MIP 2.0
#define USE_AOMAP
...
float computeSpecularOcclusion( const in float dotNV, const in float ambientOcclusion, const in float roughness ) {
	...
	uniform sampler2D spotLightMap[ 0 ];
		...
		#define SUN_LIGHT_CASCADES 2
			...
			uniform sampler2DShadow sunShadowMap[ 0 ];
		#else
			uniform sampler2D sunShadowMap[ 0 ];
		#endif
		uniform mat4 sunShadowMatrix[ 0 * SUN_LIGHT_CASCADES ];
		uniform vec4 sunShadowCascade[ 0 * SUN_LIGHT_CASCADES ];
		...
		uniform SunLightShadow sunLightShadows[ 0 ];
	#endif
	#if 1 > 0
		#if defined( SHADOWMAP_TYPE_PCF )
	...
	#if 1 > 0
		#if defined( SHADOWMAP_TYPE_PCF )
			uniform sampler2DShadow spotShadowMap[ 1 ];
		#else
	...
	#if 1 > 0
		#if defined( SHADOWMAP_TYPE_PCF )
			uniform samplerCubeShadow pointShadowMap[ 1 ];
		#elif defined( SHADOWMAP_TYPE_BASIC )
			uniform samplerCube pointShadowMap[ 1 ];
		#endif
...
IncidentLight directLight;
	...
	PointLightShadow pointLightShadow;
		...
		#if defined( USE_SHADOWMAP ) && ( 0 < 1 ) && ( defined( SHADOWMAP_TYPE_PCF ) || defined( SHADOWMAP_TYPE_BASIC ) )
	...
	SpotLightShadow spotLightShadow;
		...
		directLight.color *= ( directLight.visible && receiveShadow ) ? getShadow( spotShadowMap[ 0 ], spotLightShadow.shadowMapSize, spotLightShadow.shadowIntensity, spotLightShadow.shadowBias, spotLightShadow.shadowRadius, vSpotLightCoord[ 0 ] ) : 1.0;
		#endif
		RE_Direct( directLight, geometryPosition, geometryNormal, geometryViewDir, geometryClearcoatNormal, material, reflectedLight );
	...
	DirectionalLightShadow directionalLightShadow;
		...
		directLight.color *= ( directLight.visible && receiveShadow ) ? getShadow( directionalShadowMap[ 0 ], directionalLightShadow.shadowMapSize, directionalLightShadow.shadowIntensity, directionalLightShadow.shadowBias, directionalLightShadow.shadowRadius, vDirectionalShadowCoord[ 0 ] ) : 1.0;
		#endif
		RE_Direct( directLight, geometryPosition, geometryNormal, geometryViewDir, geometryClearcoatNormal, material, reflectedLight );
