...
#define CLEARCOAT_NORMALMAP_UV uv
#define SHEEN_COLORMAP_UV uv
#define SPECULAR_INTENSITYMAP_UV uv
#define USE_TANGENT
#define HAS_NORMAL
...
#endif
#if 1 > 0
	uniform mat4 spotLightMatrix[ 1 ];
...
gl_Position = projectionMatrix * mvPosition;
...
#if defined( USE_ENVMAP ) || defined( DISTANCE ) || defined ( USE_SHADOWMAP ) || defined ( USE_TRANSMISSION ) || 1 > 0
...
#endif
#if ( defined( USE_SHADOWMAP ) && ( 1 > 0 || 0 > 0 || 1 > 0 ) ) || ( 1 > 0 )
	#ifdef HAS_NORMAL
	...
	vec4 shadowWorldPosition;
		...
		shadowWorldPosition = worldPosition;
			...
			shadowWorldPosition.xyz += shadowWorldNormal * spotLightShadows[ 0 ].shadowNormalBias;
		#endif
		vSpotLightCoord[ 0 ] = spotLightMatrix[ 0 ] * shadowWorldPosition;
