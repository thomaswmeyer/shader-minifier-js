...
#define STD_NORMAL_TEXTURE
#define STD_NORMAL_TEXTURE_ALLOCATE
#define STD_DIFFUSE_TEXTURE
#define STD_DIFFUSE_TEXTURE_ALLOCATE
#define STD_EMISSIVE_TEXTURE
#define STD_EMISSIVE_TEXTURE_ALLOCATE
#define LIT_NEEDS_NORMAL
#define LIT_LIGHTING
#define LIT_CLUSTERED_SHADOWS
#define LIT_TBN
#define LIT_ADD_AMBIENT
#define LIT_USE_NORMALS
#define LIT_OPACITY_FADES_SPECULAR
#define LIT_DIFFUSE_MAP
#define LIT_FRESNEL_MODEL SCHLICK
#define LIT_NONE_SLICE_MODE SIMPLE
#define LIT_BLEND_TYPE NONE
...
void getAlbedo() {
	dAlbedo = material_diffuse.rgb;
		vec3 albedoTexture = decodeGamma(texture2DBias(texture_diffuseMap, vUv0, textureBias)).rgb;
...
void getNormal() {
	vec3 normalMap = unpackNormalXYZ(texture2DBias(texture_normalMap, vUv0, textureBias));
...
void getEmission() {
	...
	dEmission *= decodeGamma(texture2DBias(texture_emissiveMap, vUv0, textureBias)).rgb;
}
