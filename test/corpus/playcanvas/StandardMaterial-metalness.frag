...
#define STD_METALNESS_TEXTURE
#define STD_METALNESS_TEXTURE_ALLOCATE
#define STD_GLOSS_TEXTURE
#define STD_GLOSS_TEXTURE_ALLOCATE
#define STD_GLOSS_CONSTANT
#define LIT_SPECULAR
#define LIT_SPECULAR_FRESNEL
#define LIT_SPECULAR_OR_REFLECTION
#define LIT_NEEDS_NORMAL
#define LIT_LIGHTING
#define LIT_METALNESS
...
void getMetalness() {
	float metalness = 1.0;
	metalness *= texture2DBias(texture_metalnessMap, vUv0, textureBias).g;
...
void getGlossiness() {
	...
	dGlossiness *= texture2DBias(texture_glossMap, vUv0, textureBias).g;
